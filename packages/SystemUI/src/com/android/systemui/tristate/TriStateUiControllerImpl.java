    ...
    private void updateTriStateLayout() {
        if (mContext != null) {
            ...
            if (res != null) {
                ...
                boolean isTsKeyRight =
                        (triStatePos == TRI_STATE_UI_POSITION_LEFT) ? false : true;
                switch (mOrientationType) {
                    case ROTATION_90:
                        gravity = (isTsKeyRight) ? 51 : 83;
